...
fig, axs = plt.subplots(nrows=1, ncols=2, dpi=600, figsize=(6, 3), tight_layout=True)
ax, ax3 = axs
...
legend_elements = [Patch(facecolor='#E24A33', edgecolor='#E24A33', label='CBC'),
                     Patch(facecolor='#348ABD', edgecolor='#348ABD', label='RBR'),
...
ax3.legend(handles=legend_elements, loc='upper left', prop={'size': 6})
