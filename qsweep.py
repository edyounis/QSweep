...
class ElemsToZero(DifferentiableCostFunction):
    def __init__(self, circuit: Circuit, target: UnitaryMatrix, i_s: list[int], j_s: list[int]) -> None:
...
class ElemsToZeroGenerator(CostFunctionGenerator):
    def __init__(self, i_s: list[int], j_s: list[int]) -> None:
        self.i_s = i_s
        self.j_s = j_s
    ...
    def gen_cost(
        ...
        return ElemsToZero(circuit, target, self.i_s, self.j_s)


class ElemsToZeroAndOneToOneCost(DifferentiableCostFunction):
    def __init__(self, circuit: Circuit, target: UnitaryMatrix, i_s: list[int], j_s: list[int], ri: int, rj: int) -> None:
        """Initialize the SingleQuditLevelCost."""
        self.target_dagger = target.conj().T
        self.circuit = circuit
        self.i_s = i_s
...
class ElemsToZeroAndOneToOneCostGenerator(CostFunctionGenerator):
    def __init__(self, i_s: list[int], j_s: list[int], ri: int, rj: int) -> None:
        self.i_s = i_s
        self.j_s = j_s
        self.ri = ri
        self.rj = rj
    ...
    def gen_cost(
        ...
        """Generate a CostFunction, see CostFunctionGenerator for more info."""
        return ElemsToZeroAndOneToOneCost(circuit, target, self.i_s, self.j_s, self.ri, self.rj)
